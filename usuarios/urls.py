...
urlpatterns = patterns('',
	...
	url(r'^perfil/user_utn/(?P<pk>[0-9]+)$',ver_informacion_perfil_utn, name='ver_informacion_perfil_utn'),
...
urlpatterns += patterns('',
	...
	url(r'^alumnosUTN/eliminar/(?P<pk>[0-9]+)$', delete_alumnoUTN, name='delete_alumnoUTN'),
